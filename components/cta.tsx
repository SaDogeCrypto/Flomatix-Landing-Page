  ...
  return (
    <section className="py-24 px-6 bg-gradient-to-br from-ms-blue to-teams-purple text-center">
      <div className="max-w-[700px] mx-auto">
        <h2 className="text-3xl md:text-4xl font-semibold text-white mb-4">Ready to simplify project updates?</h2>
        <p className="text-lg text-white/90 mb-8">
          Join thousands of teams using Mini to stay informed without the hassle.
        </p>
        <Link
          href="#"
